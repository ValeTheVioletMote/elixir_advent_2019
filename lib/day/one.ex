defmodule Advent.Day.One do
  ...
  Can also take in a list of those values and return the sum cost, using tasks for concurrent work.
  ...
  Also Handles a list for the new form of fuel determination.
